	...
	<view :data-theme="theme">
		<view class='personal-data borderPad'>
			...
			<view class='list borRadius14 mt20 bg--w111-fff'>
				...
				<view class="item acea-row row-between-wrapper">
					<view>资质证明</view>
					<navigator url="/pages/agreement/info/index?from=intelligentinfo" hover-class="none"
						class="input">
				...
				<view class="item acea-row row-between-wrapper">
					<view>协议规则</view>
					<navigator url="/pages/agreement/rules/index" hover-class="none" class="input">
						点击查看<text class="iconfont icon-ic_rightarrow"></text>
					</navigator>
				</view>
				<view class="item acea-row row-between-wrapper">
...
<script>
  ...
  function goToAgreement(from) {
    uni.navigateTo({
      animationType: animationType.type,
      animationDuration: animationType.duration,
      url: `/pages/agreement/info/index?from=${from}`
    });
  }
