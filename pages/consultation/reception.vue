<template>
	<view class="page">
		<view class="nav-bar">
			...
			<text class="nav-title">接诊</text>
		</view>
		<view class="content">
			<view class="placeholder"><text>接诊 页面开发中...</text></view>
		</view>
	</view>
</template>
...
.content { display: flex; justify-content: center; align-items: center; padding: 160rpx 0; }
