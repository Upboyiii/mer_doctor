...
export default {
	 ...
	 * this.Tips({title:'提示'},{tab:1,url:'/pages/workbench/index'}); 提示并跳转值table上
	...
	navigateTo(url) {
		if (url.indexOf("http") !== -1) {
			...
			if (['/pages/workbench/index', '/pages/consultation/index', '/pages/mine/index'
				].indexOf(url) == -1) {
				uni.navigateTo({
